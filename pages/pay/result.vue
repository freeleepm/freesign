...
<!--  <s-layout title="支付结果" :bgStyle="{ color: '#FFF' }">-->
    <view class="pay-result-box ss-flex-col ss-row-center ss-col-center" style="background-color: #fff">
      <!-- 信息展示 -->
...
<script setup>
  ...
  function onOrder() {
    ...
    } else if(state.orderType === 'sign') {
      sheep.$router.redirect('/pages/index/iou');
    } else {
