...
<!--  <s-layout title="我的团队" :class="state.scrollTop ? 'team-wrap' : ''" navbar="inner">-->
    <view  style="width: 100%;height: 100%;">
      <view class="promoter-list">
        ...
        <!--        style="background-color: #e93323 !important; height: 218rpx; color: #fff"-->
        <!--      >-->
...
<!--              >-->
<!--                团队排序-->
<!--                &lt;!&ndash; TODO 芋艿：看看怎么从项目里拿出去 &ndash;&gt;-->
...
<!--                </view>-->
            ...
            <block v-if="state.pagination.list.length === 0">
              <view style="text-align: center;margin-top: 10rpx;">暂无推广人数</view>
            </block>
          </view>
        </view>
      </view>
